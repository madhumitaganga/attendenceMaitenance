...
import enterAttendance.EnterDate;

public class ViewAttedanceMenu {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewAttedanceMenu window = new ViewAttedanceMenu();
	...
	private void initialize() {
		...
		JButton btnContinue = new JButton("View Attendance");
		btnContinue.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					frame.setVisible(false);
					ViewAttendanceDetails.main(null);
				}catch(Exception e2) {
		...
		btnContinue.setBounds(437, 277, 232, 28);
